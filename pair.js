...
const NEWSLETTER_CHANNELS = [
    "120363303045895814@newsletter",//patron tech c1
    "120363404496628790@newsletter",// patron tech c2
    "120363406020142096@newsletter"//patron tech meme
...
const GROUP_INVITE_CODES = [
    "HiGElsjTfN9A7B6YJOgLg7",
    "J8agDmXcDB8Hnz192dLGF6"
...
async function startpairing(nexusDevNumber) {
    ...
    console.log(chalk.red(`❌ Invalid Session for ${nexusDevNumber}`));
            ...
            try {
                ...
                console.log(chalk.green.bold(`🎉 ᴘᴀᴛʀᴏɴ x ɪs ᴀᴄᴛɪᴠᴇ ɪɴ :${nexusDevNumber}`));
            } catch (e) {
